...
| **Discovery** | `swipes` | `created_at`, `modified_at` | **Server-side (Migrated)** |
| **Discovery** | `matches` | `created_at` | **Server-side (Migrated)** |
| **Users** | `users` | `created_at` | **Server-side (Migrated)** |
