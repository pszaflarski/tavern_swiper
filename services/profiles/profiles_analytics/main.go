...
func main() {
	...
	log.Printf("🚀 Starting Profiles BigQuery CDC Replicator Service...")
	...
	r.GET("/", func(c *gin.Context) {
		c.String(http.StatusOK, "Profiles CDC Replicator is running")
	})
	...
	log.Printf("🚀 Profiles Replicator Listening on port %s", port)
