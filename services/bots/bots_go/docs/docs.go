...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.BotCreate"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.CredsResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.BotProfileUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "main.BotCreate": {
            ...
            "properties": {
                "description": {
                    "description": "Internal notes about this bot (not shown in-app)",
                    "type": "string"
                },
                "slug": {
                    "type": "string"
        ...
        "main.BotProfileUpdate": {
            "type": "object",
            "properties": {
                "agent_name": {
                    "description": "e.g. \"grogmar\"",
                    "type": "string"
                },
                "behavior_type": {
                    "description": "e.g. \"tavern_keeper\", \"quest_giver\"",
