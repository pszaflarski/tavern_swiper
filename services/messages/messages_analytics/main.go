...
func main() {
	...
	log.Printf("🚀 Starting Messages BigQuery CDC Replicator Service...")
	...
	r.GET("/", func(c *gin.Context) {
		c.String(http.StatusOK, "Messages CDC Replicator is running")
	})
	...
	log.Printf("🚀 Messages Replicator Listening on port %s", port)
