...
func main() {
	...
	log.Printf("🚀 Starting Users BigQuery CDC Replicator Service...")
	...
	r.GET("/", func(c *gin.Context) {
		c.String(http.StatusOK, "Users CDC Replicator is running")
	})
	...
	log.Printf("🚀 Users Replicator Listening on port %s", port)
