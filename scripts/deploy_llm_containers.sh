...
deploy_qwen_32b() {
  ...
  gcloud run deploy "${service_name}" \
    ...
    --args="/models/Qwen/Qwen2.5-32B-Instruct-AWQ,--port,8080,--max-model-len,16384,--gpu-memory-utilization,0.96,--kv-cache-dtype,fp8,--enable-auto-tool-choice,--tool-call-parser,hermes,--enforce-eager"
