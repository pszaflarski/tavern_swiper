...
deploy_qwen_32b() {
  ...
  gcloud run deploy "${service_name}" \
    ...
    --args="/models/Qwen/Qwen2.5-32B-Instruct-GGUF/Qwen2.5-32B-Instruct-Q3_K_M.gguf,--tokenizer,/models/Qwen/Qwen2.5-32B-Instruct-AWQ,--port,8080,--max-model-len,32768,--gpu-memory-utilization,0.95,--enable-auto-tool-choice,--tool-call-parser,hermes,--enforce-eager"
